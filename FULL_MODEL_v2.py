...
NMOS_OFF_1u = read_text(r'Packages/txt/NMOS_OFF_1u.txt')
NMOS_OFF_2u = read_text(r'Packages/txt/NMOS_OFF_2u.txt')
NMOS_OFF_3u = read_text(r'Packages/txt/NMOS_OFF_3u.txt')
NMOS_OFF_4u = read_text(r'Packages/txt/NMOS_OFF_4u.txt')
NMOS_OFF_6u = read_text(r'Packages/txt/NMOS_OFF_6u.txt')
NMOS_OFF_8u = read_text(r'Packages/txt/NMOS_OFF_8u.txt')

PMOS_OFF_1u = read_text(r'Packages/txt/PMOS_OFF_1u.txt')
PMOS_OFF_2u = read_text(r'Packages/txt/PMOS_OFF_2u.txt')
PMOS_OFF_3u = read_text(r'Packages/txt/PMOS_OFF_3u.txt')
PMOS_OFF_4u = read_text(r'Packages/txt/PMOS_OFF_4u.txt')
PMOS_OFF_6u = read_text(r'Packages/txt/PMOS_OFF_6u.txt')
PMOS_OFF_8u = read_text(r'Packages/txt/PMOS_OFF_8u.txt')

NMOS_ON_1u = read_text(r'Packages/txt/NMOS_ON_1u.txt')
NMOS_ON_2u = read_text(r'Packages/txt/NMOS_ON_2u.txt')
NMOS_ON_3u = read_text(r'Packages/txt/NMOS_ON_3u.txt')
NMOS_ON_4u = read_text(r'Packages/txt/NMOS_ON_4u.txt')
NMOS_ON_6u = read_text(r'Packages/txt/NMOS_ON_6u.txt')
NMOS_ON_8u = read_text(r'Packages/txt/NMOS_ON_8u.txt')

PMOS_ON_1u = read_text(r'Packages/txt/PMOS_ON_1u.txt')
PMOS_ON_2u = read_text(r'Packages/txt/PMOS_ON_2u.txt')
PMOS_ON_3u = read_text(r'Packages/txt/PMOS_ON_3u.txt')
PMOS_ON_4u = read_text(r'Packages/txt/PMOS_ON_4u.txt')
PMOS_ON_6u = read_text(r'Packages/txt/PMOS_ON_6u.txt')
PMOS_ON_8u = read_text(r'Packages/txt/PMOS_ON_8u.txt')
